  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['zguanorg:info:edit', 'zguanorg:check:query']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['zguanorg:info:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['zguanorg:info:export']"
        >导出</el-button>
      </el-col>
    </el-row>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['zguanorg:info:detail']"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="150px" :disabled="openWatch">
        <el-form-item label="账管人机构ID" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入账管人机构ID" />
        </el-form-item>
        <el-form-item label="账管人机构名称" prop="deptName">
